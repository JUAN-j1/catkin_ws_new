...
realimage_clean = cv::imread("/home/robcib/Desktop/final/xxxm/mapa_XXXm_real.tif",cv::IMREAD_LOAD_GDAL| cv::IMREAD_COLOR );
...
cv::imwrite("/home/robcib/Desktop/final/mapa_sat_planned_1.jpg",goalsImage);
cv::imwrite("/home/robcib/Desktop/final/mapa_sat_planned_2.jpg",miniLaCabrera);
cv::imwrite("/home/robcib/Desktop/final/mapa_sat_planned_3.jpg",realimage);
cv::imwrite("/home/robcib/Desktop/final/mapa_sat_planned_4.jpg",miniDem2);
cv::imwrite("/home/robcib/Desktop/final/mapa_sat_planned_5.jpg",miniDem);
}
...
image = cv::imread("/home/robcib/Desktop/final/xxxm/mapa_XXXm.tif",cv::IMREAD_LOAD_GDAL| cv::IMREAD_COLOR );
realimage = cv::imread("/home/robcib/Desktop/final/xxxm/mapa_XXXm_real.tif",cv::IMREAD_LOAD_GDAL| cv::IMREAD_COLOR );
//Mat image_show = cv::imread("/home/robcib/Desktop/lacabrera/lacabrera.jpg",cv::IMREAD_LOAD_GDAL| cv::IMREAD_COLOR );
dem = cv::imread("/home/robcib/Desktop/final/xxxm/prueba_XXXm9.tif", cv::IMREAD_LOAD_GDAL| cv::IMREAD_ANYDEPTH );
   ...
   if(key==49)
	 ...
	 printf("\n");
        ...
        // std::system("gnome-terminal -- roslaunch unit3_pp unit3_astar_solution.launch");
           std::system("gnome-terminal -- roslaunch unit3_pp unit3_dijkstra.launch");
