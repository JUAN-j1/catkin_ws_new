...
image = cv::imread("/home/robcib/Desktop/final/rio_tinto/mapa_topografico_prueba.tif",cv::IMREAD_LOAD_GDAL| cv::IMREAD_COLOR );
realimage = cv::imread("/home/robcib/Desktop/final/rio_tinto/mapa_real_prueba.tif",cv::IMREAD_LOAD_GDAL| cv::IMREAD_COLOR );
//Mat image_show = cv::imread("/home/robcib/Desktop/lacabrera/lacabrera.jpg",cv::IMREAD_LOAD_GDAL| cv::IMREAD_COLOR );
dem = cv::imread("/home/robcib/Desktop/final/rio_tinto/mapa_dem_prueba.tif", cv::IMREAD_LOAD_GDAL| cv::IMREAD_ANYDEPTH );
