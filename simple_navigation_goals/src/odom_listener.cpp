...
{
if(sqrt( ((pos_x - b_pos_x)*(pos_x - b_pos_x)) + ((pos_y - b_pos_y)*(pos_y - b_pos_y)))< 4.0 ) return 3;
/*
else
{ 
...
{
if(sqrt( ((pos_x - b_pos_x)*(pos_x - b_pos_x)) + ((pos_y - b_pos_y)*(pos_y - b_pos_y)))> 5.0 ) return 3;
/*
else
{ 
if(sqrt( ((pos_x - b_pos_x)*(pos_x - b_pos_x)) + ((pos_y - b_pos_y)*(pos_y - b_pos_y)))> 8.0 ) return 2;
...
{
if(sqrt( ((pos_x - c_pos_x)*(pos_x - c_pos_x)) + ((pos_y - c_pos_y)*(pos_y - c_pos_y)))< 4.0 ) return 3;
/*
else 
{
...
{
if(sqrt( ((pos_x - d_pos_x)*(pos_x - d_pos_x)) + ((pos_y - d_pos_y)*(pos_y - d_pos_y)))< 4.0 ) return 3;
/*
else
{
...
{
if(sqrt( ((c_pos_x - b_pos_x)*(c_pos_x - b_pos_x)) + ((c_pos_y - b_pos_y)*(c_pos_y - b_pos_y)))< 4.0 ) return 3;
/*
else
{
...
{
if(sqrt( ((c_pos_x - b_pos_x)*(c_pos_x - b_pos_x)) + ((c_pos_y - b_pos_y)*(c_pos_y - b_pos_y)))> 10.0 ) return 3;
/*
else
{
if(sqrt( ((c_pos_x - b_pos_x)*(c_pos_x - b_pos_x)) + ((c_pos_y - b_pos_y)*(c_pos_y - b_pos_y)))> 8.0 ) return 2;
...
{
if(sqrt( ((d_pos_x - b_pos_x)*(d_pos_x - b_pos_x)) + ((d_pos_y - b_pos_y)*(d_pos_y - b_pos_y)))< 4.0 ) return 3;
/*
else
{
...
{
if(sqrt( ((d_pos_x - b_pos_x)*(d_pos_x - b_pos_x)) + ((d_pos_y - b_pos_y)*(d_pos_y - b_pos_y)))> 10.0 ) return 3;
/*
else
{
if(sqrt( ((d_pos_x - b_pos_x)*(d_pos_x - b_pos_x)) + ((d_pos_y - b_pos_y)*(d_pos_y - b_pos_y)))> 12.0 ) return 2;
...
if(sqrt( ((c_pos_x - d_pos_x)*(c_pos_x - d_pos_x)) + ((c_pos_y - d_pos_y)*(c_pos_y - d_pos_y)))< 4.0 ) return 3;
/*
else
{
...
if(sqrt( ((c_pos_x - d_pos_x)*(c_pos_x - d_pos_x)) + ((c_pos_y - d_pos_y)*(c_pos_y - d_pos_y)))> 10.0 ) return 3;
/*
else
{
if(sqrt( ((c_pos_x - d_pos_x)*(c_pos_x - d_pos_x)) + ((c_pos_y - d_pos_y)*(c_pos_y - d_pos_y)))> 8.0 ) return 2;
...
if(suma==0 )  ROS_INFO("EVERYTHING FINE");
